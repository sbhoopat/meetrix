  ...
  return (
    <div className="fixed top-0 left-0 right-0 bottom-0 bg-gray-500 bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-lg w-full sm:max-w-md md:max-w-lg lg:max-w-xl">
        <h2 className="text-xl font-semibold mb-4 text-center text-[#002133]">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex justify-end space-x-3">
            <button
              onClick={onClose}
              className="px-4 py-2 bg-gray-300 text-white rounded-lg text-sm w-full sm:w-auto"
            >
              Cancel
            </button>
            <button
              onClick={handleSave}
              className="px-4 py-2 bg-green-500 text-white rounded-lg text-sm w-full sm:w-auto"
            >
              Save
            </button>
          </div>
