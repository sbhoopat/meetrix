  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6">
      <div className="flex flex-col md:flex-row w-full max-w-5xl shadow-2xl rounded-2xl overflow-hidden">
        ...
        {/* Left Section */}
        <div
          className="md:w-1/2 flex flex-col justify-center items-center p-10 text-white"
          style={{ backgroundColor: "#002133" }}
        >
          <motion.div
        ...
        >
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            <input
              type="email"
              placeholder="E-mail"
              className="border border-gray-300 px-4 py-2 rounded-lg focus:ring-2 focus:ring-[#002133] focus:outline-none"
              required
            />
            <input
              type="password"
            ...
            <button
              type="submit"
              className="mt-3 bg-[#002133] hover:bg-[#00394d] text-white py-2 rounded-lg font-medium transition"
            >
